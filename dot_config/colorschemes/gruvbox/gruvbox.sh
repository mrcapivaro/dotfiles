...
export GRUVBOX_DARK_RED_HARD="#792329"
export GRUVBOX_DARK_RED="#722529"
export GRUVBOX_DARK_RED_SOFT="#7b2c2f"
export GRUVBOX_LIGHT_RED_HARD="#fc9690"
export GRUVBOX_LIGHT_RED="#fc9487"
export GRUVBOX_LIGHT_RED_SOFT="#f78b7f"
export GRUVBOX_DARK_GREEN_HARD="#5a633a"
export GRUVBOX_DARK_GREEN="#62693e"
export GRUVBOX_DARK_GREEN_SOFT="#686d43"
export GRUVBOX_LIGHT_GREEN_HARD="#d3d6a5"
export GRUVBOX_LIGHT_GREEN="#d5d39b"
export GRUVBOX_LIGHT_GREEN_SOFT="#cecb94"
export GRUVBOX_DARK_AQUA_HARD="#3e4934"
export GRUVBOX_DARK_AQUA="#49503b"
export GRUVBOX_DARK_AQUA_SOFT="#525742"
export GRUVBOX_LIGHT_AQUA_HARD="#e6e9c1"
export GRUVBOX_LIGHT_AQUA="#e8e5b5"
export GRUVBOX_LIGHT_AQUA_SOFT="#e1dbac"
