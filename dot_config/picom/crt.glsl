// src: https://github.com/ikz87/picom-shaders
#version 430
...
uniform float sc_intensity = 0.4; // Intensity of the scanline effect
...
uniform float sph_distance = 10000; // Distance from the theoretical sphere
