    ...
    keys = {
        ...
        },
        {
            ...
            action = act.SpawnCommandInNewTab({
                ...
                cwd = "/home/mrcapivaro/.config/wezterm",
        ...
        },
        {
            key = "H",
            mods = "CTRL",
            action = act.EmitEvent("user-defined-4"),
        },
        {
            key = "J",
            mods = "CTRL",
            action = act.EmitEvent("user-defined-5"),
        },
        {
            key = "K",
            mods = "CTRL",
            action = act.EmitEvent("user-defined-6"),
        },
        {
            key = "L",
            mods = "CTRL",
            action = act.EmitEvent("user-defined-7"),
        },
        ...
        },
        {
            key = "k",
            mods = "CTRL",
            action = act.EmitEvent("user-defined-2"),
        },
        {
            key = "k",
            mods = "SUPER",
        ...
        },
        {
            key = "l",
            mods = "CTRL",
            action = act.EmitEvent("user-defined-3"),
        },
        { key = "m", mods = "SHIFT|CTRL", action = act.Hide },
        ...
        },
        {
            ...
            action = act.SpawnCommandInNewTab({
                args = {
                    "sed",
                    "-i",
                    "'/^local\u{20}current_theme/c\\local\u{20}current_theme\u{20}=\u{20}light_theme'",
                    "wezterm.lua",
                },
                cwd = "/home/mrcapivaro/.config/wezterm",
                domain = "CurrentPaneDomain",
